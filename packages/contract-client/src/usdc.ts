...
export type DataKey = {tag: "Admin", values: void} | {tag: "FaucetAt", values: readonly [string]};
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABAAAAAAAAAAAAAAABUVycm9yAAAAAAAAAQAAAAAAAAAORmF1Y2V0Q29vbGRvd24AAAAAAA4=",
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAAAgAAAAAAAAAAAAAABUFkbWluAAAAAAAAAQAAAAAAAAAIRmF1Y2V0QXQAAAABAAAAEw==",
